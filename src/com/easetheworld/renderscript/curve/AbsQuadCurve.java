...
public abstract class AbsQuadCurve {

    static final String TAG = "QuadCurve";
    ...
    public AbsQuadCurve(Context context) {
    ...
    public abstract void moveTo(float x, float y, float r, int color);

    public void quadTo(float x1, float y1, float x2, float y2) {
        quadTo(x1, y1, radiusForDefault, colorForDefault, x2, y2, radiusForDefault, colorForDefault);
    }

    public abstract void quadTo(float x1, float y1, float r1, int c1, float x2, float y2, float r2, int c2);

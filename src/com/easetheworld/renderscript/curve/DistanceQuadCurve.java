...
public class DistanceQuadCurve extends AbsQuadCurve {

    private final ScriptC_distancebezier script;
    ...
    public DistanceQuadCurve(Context context) {
        super(context);
        rs = RenderScript.create(context);

        script = new ScriptC_distancebezier(rs);
